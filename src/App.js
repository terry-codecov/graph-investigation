        ...
        <div className="App">
          <nav>
            <p>
              ...
              The data set is 300 data points.
            </p>
            <ul>
              <li>
              ...
              <li>
                <Link to="/d3-react-rendered">
                  D3 powered but React Rendered
                </Link>
              </li>
              <li>
                <Link to="/ant-design-scatterplot">
                  @ant-design/scatterplot
                </Link>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <Link to="/d3-react-rendered-full">
                  D3 powered but React Rendered
                </Link>
              </li>
              <li>
                <Link to="/ant-design-scatterplot-full">
                  @ant-design/scatterplot
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/recharts-scatterplot-full">
              ...
              <div className="row">
                <div className="explainer">
                  ...
                  <p>
                    ...
                    and render/selects provided. The "D3" part is handled by
                    various scales (binding the positioning, colors, etc inside
                    a domain and range) and access to things tick calculation
                    (creating charting axis). The rendering has proven highly
                    customizable and looks easy to maintain as it's normal react
                    components / testing.
                  </p>
                  <p>
                    More features are possible, I just didnt spend the time as I
              ...
              <div className="row">
                <div className="explainer">
                  ...
                  <p>
                    ...
                    it also sadly is using a deprecated react API so there's dev
              ...
              <div className="row">
                <div className="explainer">
                  ...
                  <p>
                    ...
                    the toolips values. Limited visuals. Rerenders on hover,
                    hover effects kinda weird and locked in.
                  </p>
                </div>
              ...
              <div className="row">
                <div className="explainer">
                  ...
                  <p>
                    ...
                    modified for the stress test). Hover state is CSS powered
                    and will some times be limited in terms of accuracy due to
                    how it's rendered (It's a table). Though it has less
                    features in terms of interactivity, it's highly
                    customizable, performant, and supports screen readers and
                    printing.
                  </p>
                  <p>
